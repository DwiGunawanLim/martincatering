...
class Detail_model extends CI_Model
{
    ...
    {
        $this->db->select('d.*, r.nama as nama, b.nama as makanan');
        $this->db->from('detail_penjualan d');
        $this->db->join('user r', 'd.id_user = r.id');
        $this->db->join('makanan b', 'd.id_makanan = b.id');
    ...
    public function getByUser($id)
    {
        ...
        $this->db->select('d.*, b.nama as makanan');
        $this->db->from('detail_penjualan d');
        $this->db->join('makanan b', 'd.id_makanan = b.id');
    ...
    function charts()
    {
        $this->db->select('d.*, b.nama as makanan, sum(d.jumlah) as jum');
        $this->db->from('detail_penjualan d');
        $this->db->join('makanan b', 'd.id_makanan = b.id');
